...
# print(glob.glob("Full_calibration/D2/*"))
mtx1, dist1 = calibrate_camera(images_folder = 'Full_calibration\D2\*')
mtx2, dist2 = calibrate_camera(images_folder = 'Full_calibration\J2\*')
