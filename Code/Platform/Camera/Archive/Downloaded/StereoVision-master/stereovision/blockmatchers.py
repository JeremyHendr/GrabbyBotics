...
class StereoBM(BlockMatcher):
    ...
    parameter_maxima = {"search_range": None,
                       "window_size": 255,
                       "stereo_bm_preset": cv2.STEREO_BM_PREFILTER_NORMALIZED_RESPONSE} #STEREO_BM_NARROW_PRESET
    ...
    def stereo_bm_preset(self, value):
        ...
        if value in (cv2.STEREO_BM_PREFILTER_NORMALIZED_RESPONSE,
    ...
    def __init__(self, stereo_bm_preset=cv2.STEREO_BM_PREFILTER_NORMALIZED_RESPONSE,
                 ...
                 window_size=21,
                 settings=None):
        self._bm_preset = cv2.STEREO_BM_PREFILTER_NORMALIZED_RESPONSE
