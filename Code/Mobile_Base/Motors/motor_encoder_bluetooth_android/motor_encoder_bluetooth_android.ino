 ...
 * Code: Displays the calculated values on the Android App
 * Julius Ortstadt
 * 09.09.2024
*/
...
void loop() {
  ...
  if (currentMillis - previousMillis > interval){
    ...
    stop();
    BlueT.println("*A-----> Motor M1 Data <----- Measurement: " + String(measurement) + "\n*");
    BlueT.print("*AM1 tick count: " + String(M1_tick_count) + "\n*");
    ...
    BlueT.print("*ARPM Motor shaft value at " + String(speed) + " PWM: " + String(RPM1_M1) + "\n*");
    BlueT.print("*ARPM Gearbox shaft value at " + String(speed) + " PWM: " + String(RPM2_M1) + "\n*");
    M1_distance += (RPM2_M1 / 60) * wheel_circumference * (interval * pow(10,-3));
    BlueT.print("*ADistance travelled in m: " + String(M1_distance) + "\n*");
    ...
    BlueT.println("*B-----> Motor M2 Data <----- Measurement: " + String(measurement) + "\n*");
    BlueT.print("*BM2 tick count: " + String(M2_tick_count) + "\n*");
    ...
    BlueT.print("*BRPM Motor shaft value at " + String(speed) + " PWM: " + String(RPM1_M2) + "\n*");
    BlueT.print("*BRPM Gearbox shaft value at " + String(speed) + " PWM: " + String(RPM2_M2) + "\n*");
    M2_distance += (RPM2_M2 / 60) * wheel_circumference * (interval * pow(10,-3));
    BlueT.print("*BDistance travelled in m: " + String(M2_distance) + "\n*");
